...
DATASET_PATH = "dataset/Simple_questions/questions.csv"
...
def save_results_to_csv(results, filename):
    with open(filename, mode='w', newline='', encoding='utf-8') as file:
        ...
        writer.writerow(["ID", "Problem", "Model Response", "Extracted Answer", "Ground Truth", "Correct", "Latency", "Input Tokens", "Output Tokens"])
...
def main():
    ...
    save_results_to_csv(results, f"dataset/Simple_questions_results/simple_questions_evaluation_results_{model_used.replace('/', '_')}.csv")
    print(f"\nModel: {model_used}")
